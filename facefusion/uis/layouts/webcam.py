...
def run(ui : gradio.Blocks) -> None:
	...
	ui.queue(concurrency_count = concurrency_count).launch(server_name='0.0.0.0', server_port=7862,show_api = False, quiet = True, inbrowser = facefusion.globals.open_browser)